    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            ...
            if (file.startswith('C') or file.startswith('U')) and file.endswith('.txt'):
                ...
                # json1_path = f"D:\AirfoilDesign\PythonPram\模型对比数据\绘图程序\柱形图\Dyn\\{file_name}_{data_name}_CL.json"
                json1_path = f"D:\\AirfoilDesign\\PythonPram\\Dataset_all\\Sta\\CST_CLCD\\{file_name}_{data_name}_CD.json"
