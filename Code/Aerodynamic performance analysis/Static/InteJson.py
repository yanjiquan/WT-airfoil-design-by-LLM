...
# 文件夹路径
folder_path = r"D:\AirfoilDesign\PythonPram\Dataset_all\Sta\CST_CLCD"
# 输出文件
output_train_cl = r"D:\AirfoilDesign\PythonPram\Dataset_all\Sta\CST_CLCD\train_CL.jsonl"
output_train_cd = r"D:\AirfoilDesign\PythonPram\Dataset_all\Sta\CST_CLCD\train_CD.jsonl"
...
# 指定测试集翼型名称
test_airfoils = ["LS-0421", "S825", "NACA4415"]
