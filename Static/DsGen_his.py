    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            ...
            if (file.startswith('C') or file.startswith('U')) and file.endswith('.txt'):
                ...
                json1_path = f"D:\\AirfoilDesign\\PythonPram\\Dataset_all\\Sta\\CST_his\\{file_name}_{data_name}_CL.json"
                json2_path = f"D:\\AirfoilDesign\\PythonPram\\Dataset_all\\Sta\\CST_his\\{file_name}_{data_name}_CD.json"
                ...
                for i, value in enumerate(AOA):
                    ...
                    content1.append({
                        ...
                        "input":f"该翼型的雷诺数为{R}*10^6，粗糙度为光滑，历史攻角为{history_aoa}，攻角为{AOA[i]}°。"
